...
public class RoomController {
    ...
    public ResponseEntity<Room> createRoom(@PathVariable UUID hotelId, @RequestBody CreateRoomRequest request){
    ...
    @PutMapping("/{roomId}")
    public ResponseEntity<Room> updateRoom(@PathVariable UUID roomId, @RequestHeader UUID hotelId, @RequestBody CreateRoomRequest request){
