...
public class HotelController {
    ...
    @PostMapping
    public ResponseEntity<Hotel> createHotel(@RequestBody CreateHotelRequest createHotelRequest){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Hotel> updateHotel(@PathVariable UUID id, @RequestBody CreateHotelRequest request) {
